...
<div class="w3-container w3-center w3-margin-bottom w3-padding">
    <div class="w3-card-4">
        <div class="w3-container w3-light-blue">
            <%
                out.println("<h2>Customer id = " + request.getAttribute("id") + "profile.</h2>");
            %>
        </div>
        ...
        <%
            if (request.getAttribute("newId") != null) {
                out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                        ...
                        "   <h5>Customer with id = '" + request.getAttribute("id") + "' modified!</h5>\n" +
                        "</div>");
            }
        %>
        ...
        <div class="w3-card-4">
            <div class="w3-container w3-center w3-green">
                <h2>Change customer profile</h2>
            </div>
            <form method="post" class="w3-selection w3-light-grey w3-padding">
                <label>Enter new name:<input type="text" name="name"
                                             class="w3-input w3-animate-input w3-border w3-round-large"
                                             style="width: 30%"><br/>
                </label>
                <label>Enter new age:<input type="text" name="age"
                                            class="w3-input w3-animate-input w3-border w3-round-large"
                                            style="width: 30%"><br/>
                </label>
